...
C_SRCS += \
../Core/average/average.c 

OBJS += \
./Core/average/average.o 

C_DEPS += \
./Core/average/average.d 


# Each subdirectory must supply rules for building sources it contributes
Core/average/%.o Core/average/%.su Core/average/%.cyclo: ../Core/average/%.c Core/average/subdir.mk
...
clean: clean-Core-2f-average

clean-Core-2f-average:
	-$(RM) ./Core/average/average.cyclo ./Core/average/average.d ./Core/average/average.o ./Core/average/average.su

.PHONY: clean-Core-2f-average
